          ...
          <div
            ...
            <form @submit.prevent="submitForm">
              ...
              <div class="mb-6">
                ...
                <input minlength="6" v-model="password" type="password" placeholder="Password"
                  class="w-full rounded-md border border-[#E9EDF4] py-3 px-5 bg-[#FCFDFE] text-base text-body-color placeholder-[#ACB6BE] outline-none focus-visible:shadow-none focus:border-primary" />
              </div>
              <div class="mb-10">
            ...
            <p class="text-base text-[#adadad]">
              {{ authMode === 'signup' ? 'Already a member?' : 'Don not have an account?' }}
              <a @click="authMode === 'signup' ? authMode = 'signin' : authMode = 'signup' " href="javascript:void(0)" class="text-primary hover:underline">
...
export default {
  ...
  setup() {
    ...
    return { email, password, submitForm, loading, authMode, logInWithGoogle }
  }
}
</script>
