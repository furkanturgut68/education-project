<template>
  <router-link :to="{name: 'CourseView', params:{id:coursea.id} }">
  <div class="bg-white shadow-md h-[183px] w-full flex items-center px-2 justify-around rounded-md max-w-[412px]">
    <img
